        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["date", "slot_number"], name="idx_booking_date_slot"
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "apartment_number",
                    models.CharField(
                        help_text="Apartment number (e.g. A12, B3, 101).", max_length=20
                    ),
                ),
                (
                    "user",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["apartment_number"], name="idx_profile_apartment"
                    )
                ],
            },
        ),
